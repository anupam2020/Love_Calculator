        ...
        LoginManager.getInstance().registerCallback(callbackManager,
                new FacebookCallback<LoginResult>() {
                    ...
                    public void onError(FacebookException exception) {
                        // App code
                        DynamicToast.makeError(FacebookAuthActivity.this,exception.getMessage(),2000).show();
                        finish();
                    }
                });
                        ...
                        if (task.isSuccessful()) {
                            ...
                            reference.child(mAuth.getCurrentUser().getUid()).child("Profile")
                                ...
                                public void onFailure(@NonNull Exception e) {
                                    ...
                                    DynamicToast.makeError(FacebookAuthActivity.this,e.getMessage(),2000).show();
                                    finish();
                                }
                            });
